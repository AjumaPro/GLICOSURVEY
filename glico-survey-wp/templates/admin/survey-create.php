    ...
    <div class="glico-admin-container">
        ...
        <div class="glico-admin-header">
            <div class="glico-admin-header-content">
                <h1 class="glico-admin-title"><?php _e('Create Survey', 'glico-survey'); ?></h1>
                <p class="glico-admin-subtitle"><?php _e('Build your survey with our intuitive drag-and-drop builder', 'glico-survey'); ?></p>
            </div>
        ...
        <form class="glico-survey-form" id="survey-builder-form">
                ...
                <div class="glico-content-card-body">
                    ...
                    <div class="glico-form-group">
                        ...
                        <textarea id="survey-description" name="description" class="glico-form-textarea" rows="3" 
                                  placeholder="<?php _e('Enter survey description (optional)...', 'glico-survey'); ?>"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="glico-content-card">
                ...
                <div class="glico-content-card-body">
                    ...
                    <div class="glico-empty-questions" id="empty-questions">
                    ...
                    <div class="glico-form-grid">
                        <div class="glico-form-group">
                            <label class="glico-form-label">
                                <input type="checkbox" name="settings[show_progress]" value="1" checked>
                        ...
                        <div class="glico-form-group">
                            <label class="glico-form-label">
                                <input type="checkbox" name="settings[allow_back]" value="1" checked>
                        ...
                        <div class="glico-form-group">
                            <label class="glico-form-label">
                                <input type="checkbox" name="settings[auto_save]" value="1" checked>
